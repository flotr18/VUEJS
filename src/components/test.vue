<template>
    <div>
        ...
        <button @click="showOthers">TOP TEAM</button>
        <button @click="showBests">Others</button>
        <button @click="ShowMain">Show</button>
        <button @click="DeleteMain">Delete</button>
        ...
        data : function () {
            return {
                teams : [
                    ...
                    { name : "W11 - Defending champion car 2019 ", car : "W10", engine : "Mercedes", img : "https://cdn-8.motorsport.com/images/vcl/K6xbRj2Q/s3/img992460015-1.png",top : false},
